...
public class TimeAcceleratorScreen<T extends BaseMachineContainer> extends BaseMachineScreen<T> {
    private static final Identifier ADD_BUTTON = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/add.png");
    private static final Identifier REMOVE_BUTTON = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/remove.png");
    ...
    protected void changeSpeedLevel(int change) {
        ...
        minecraft.getConnection().send(new TimeAcceleratorPayload(speedLevel));
    }
